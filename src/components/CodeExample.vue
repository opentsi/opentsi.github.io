      ...
      <div class="max-w-5xl mx-auto">
        <div class="code-window">
          ...
          <div class="flex items-center justify-between px-6 py-4 border-b border-border bg-muted/30">
            <div class="text-sm font-medium text-muted-foreground">Code Examples</div>

            <!-- Language toggle -->
            <div class="inline-flex items-center rounded-lg border border-border bg-card/50 p-1">
              <button
          ...
          <!-- Code content -->
          <div class="p-8 font-mono text-sm bg-card/50 backdrop-blur-sm overflow-x-auto">
            <pre class="text-foreground leading-relaxed"><code>{{ examples[activeLanguage][activeTab] }}</code></pre>
          </div>
        </div>

        <!-- Installation -->
        <div class="mt-8 p-6 rounded-xl border border-border bg-card/50 backdrop-blur-sm">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <div v-if="activeLanguage === 'r'" class="font-mono text-sm bg-muted/50 px-4 py-3 rounded-lg space-y-1">
                <div>remotes::install_github("opentsi/opentimeseries")</div>
                <div class="text-muted-foreground"># For data providers:</div>
                <div>remotes::install_github("opentsi/deloRean")</div>
              </div>
              <div v-else class="font-mono text-sm bg-muted/50 px-4 py-3 rounded-lg space-y-1">
                <div>pip install opentsi</div>
                <div class="text-muted-foreground"># Python package coming soon</div>
              </div>
            </div>
          </div>
        </div>
